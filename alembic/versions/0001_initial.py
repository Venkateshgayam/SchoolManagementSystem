...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("employment_date", sa.DateTime(), default=sa.func.now()),
        sa.Column("status", sa.String(length=20), default="active"),
    )
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.Integer(), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
        sa.Column("target_role", sa.Enum("all", "students", "teachers", "management", name="targetrole"), nullable=True),
        sa.Column("created_at", sa.DateTime(), default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "paid", "overdue", name="feestatus"), default="pending"),
        sa.Column("academic_year", sa.String(length=20), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "approved", "rejected", name="leavestatus"), default="pending"),
