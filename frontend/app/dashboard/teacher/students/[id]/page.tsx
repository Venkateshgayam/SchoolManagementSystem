  ...
  if (error || !student) {
    return (
      <div className="card max-w-lg mx-auto text-center py-8">
        ...
        <Link href="/dashboard/teacher/students" className="btn-primary">Back to My Students</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/dashboard/teacher/students" className="p-2 bg-white border border-gray-200 rounded-md hover:bg-gray-50 transition-colors">
          ...
          trend={
            <div className="flex flex-col text-xs text-gray-500 mt-1">
              ...
              {attendanceRate > 0 && attendanceRate < attendanceThreshold && (
                <span className="text-red-600 font-medium mt-1">At Risk (Below {attendanceThreshold}%)</span>
              )}
            </div>
          }
        />
