      ...
      <div className="card max-w-lg">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            {errors.current_password && <p className="mt-1 text-sm text-danger-500">{errors.current_password.message}</p>}
          </div>
          <div>
            ...
            {errors.new_password && <p className="mt-1 text-sm text-danger-500">{errors.new_password.message}</p>}
          </div>
          <div>
            ...
            {errors.confirm_password && <p className="mt-1 text-sm text-danger-500">{errors.confirm_password.message}</p>}
          </div>
